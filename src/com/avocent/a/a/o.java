...
class o implements Runnable {
    ...
    public void run() {
        ...
        this.b.b().a(o.z[4] + screenSize.width + "x" + screenSize.height);
        ...
        if (preferredSize.width > screenSize.width || preferredSize.height > screenSize.height) {
            this.b.b().a(o.z[6] + screenSize.width + "," + screenSize.height + o.z[2] + preferredSize.width + "," + preferredSize.height + o.z[0]);
            this.b.k.pack();
            this.b.l.setVisible(false);
            this.b.k.setVisible(true);
            this.b.a(o.z[1], (Object) Boolean.FALSE);
