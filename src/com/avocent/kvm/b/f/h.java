...
public class h {
    ...
    private static final String[] z = {": ","Failed to establish SSL connection "," to Address=","createSSLSocket() About to create an SSLSocket over existing TCP socket=","Invalid arguments.","SSL handshake did not complete in timeout","The SSLSocket was created successfully and the handshake completed","createSSLSocket() --- Enabled cipher suites list","No TCP Socket passed, creating one","Unable to connect to host","TCP Socket created."," and Port=","Invalid arguments. ","createSSLSocket() SSLSocket created, about to listen for handshake","    ","SSLHelper:createSSLSocket","PKCS12"," and TrustManagerFactory=","Using client certificate to create KeyManager keystore.","createSSLSocket() About to get the SSLSocketFactory","Closing client cert file input stream.","Closing cert auth file input stream.","createSSLSocket() About to get the default SSLSocketFactory","Initializing SSL context with KeyManagerFactory=","CA alias","X.509","SSL","SSLHelper:getSslSocketFactory","SunX509","Using cert auth certificate to create TrustManager keystore.",", parsedServerCert=","serverCert=","aPeerCerts=","Server IP Address inside certificate matches the IP Address we connected to.  SSL Connection Succeeded.","Found  IP Address=","SSLHelper:verifyServerIpAddress","Server IP Address inside certificate does not match the IP Address we connected to--dropping the connection.","Server authentication required.  Getting the server certificate chain from the SSL context, then verifying IP Address in the certificate matches the one we connected to..."," inside server certificate.",", szClientCertificateFile=",", nPort=",", szClientFilePassphrase="," and bVerifyServerIpAddress=",", nTimeout=","createSSLSocket() Determining set cipher suites to enable",", szCertAuthCertificateFile=","Arguments given: socketTcpInetAddress=","SSL_DH_anon_EXPORT_WITH_DES40_CBC_SHA","SSL_RSA_WITH_RC4_128_MD5","SSL_DH_anon_WITH_3DES_EDE_CBC_SHA","SSL_RSA_WITH_DES_CBC_SHA","SSL_RSA_WITH_NULL_MD5","SSL_RSA_WITH_NULL_SHA","SSL_RSA_EXPORT_WITH_RC4_40_MD5","SSL_DH_anon_WITH_RC4_128_MD5","SSL_RSA_WITH_RC4_128_SHA","SSL_DH_anon_WITH_DES_CBC_SHA","SSL_RSA_WITH_3DES_EDE_CBC_SHA","SSL_DH_anon_EXPORT_WITH_RC4_40_MD5"};
    ...
    public static SSLSocket a(Socket socket, final String s, final int n, final int soTimeout, final String[] enabledCipherSuites, final SSLSocketFactory sslSocketFactory) throws Exception, SSLException {
        final int b = com.avocent.kvm.b.f.b.b;
    ...
    static {
        ...
        b = Integer.getInteger(z(z("p2\u0019\u001cMO\u00110&\u0006n \r\u000bkl/\u0001\u0011pw>\u0016\u0015kk$\n\u0007ay$")), 50);
        c = Integer.getInteger(z(z("p2\u0019\u001cMO\u00110&\u0006p2\u0019\u000b`b/\u0011\u0007`b*\u0010\u000b|j,\u0010\u001b}w")), 5000);
