...
public class e extends JDialog
{
    ...
    private void a() {
        ...
        this.getContentPane().add(this.h, e.z[6]);
        ...
        this.getContentPane().add(this.f, e.z[11]);
        this.pack();
    }
    ...
    private void a(final ActionEvent actionEvent) {
        ...
        System.out.println(e.z[12] + this.b + e.z[0]);
        this.setVisible(false);
    }
    
    private void a(final int n) {
        (this.c = new Timer(n * 1000, null)).addActionListener(new c(this, this));
        this.c.start();
    }
    ...
    public int a(final String s) {
        ...
        this.a.d();
        final StringBuilder append = sb.append(d.b(e.z[2])).append(e.z[0]);
        this.a.d();
        this.i.setText(append.append(d.b(e.z[1])).toString());
        this.b = 1;
